...
@objc protocol AdvancedMediaPlayer {
    ...
    @objc optional func playRMVB(fileName: String)
}
...
class MP4Player: NSObject, AdvancedMediaPlayer {
    ...
    func playMP4(fileName: String) {
        ...
        print("\(#function) function invoke")
    }
}

class RMVBPlayer: NSObject, AdvancedMediaPlayer {

    func playRMVB(fileName: String) {
...
class MediaAdapter: NSObject, MediaPlayer {
    ...
    func MediaAdapter(audioType: String) {
        
        switch audioType {
        case "mp4":
            advancedMusicPlayer = MP4Player()
        case "rmvb":
            advancedMusicPlayer = RMVBPlayer()
        default: break
        }
    }
    ...
    func play(audioType: String, fileName: String) {
        ...
        case "rmvb":
            advancedMusicPlayer?.playRMVB?(fileName: fileName)
        default: break
        }
    }
}
