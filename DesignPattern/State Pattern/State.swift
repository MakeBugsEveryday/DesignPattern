...
private protocol StateProtocol {
    
    func doAction(context: Context)
}

private class StartState: NSObject, StateProtocol {
...
private class EndState: NSObject, StateProtocol {
...
private func demo() {
    ...
    let stat1 = context.state
    
    
    let endState = StartState()
    context.state = endState
    let stat2 = context.state
}
